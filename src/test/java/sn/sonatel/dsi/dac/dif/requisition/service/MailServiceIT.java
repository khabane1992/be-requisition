package sn.sonatel.dsi.dac.dif.requisition.service;
...
import sn.sonatel.dsi.dac.dif.requisition.BerequisitionApp;
 ...
 */
@SpringBootTest(classes = BerequisitionApp.class)
